...
const Projects = ({}: {}) => {
  const projectList = [
    ...
    { text: 'Structural Steel Works', src: '/assets/7.jpg', alt: 'alt' },
    {
      text: 'Supply and Installation of Phenolic Board Protection',
      src: '/assets/5.jpg',
      alt: 'alt',
    },
    { text: '3-Unit Residential Apartment', src: '/assets/1.jpg', alt: 'alt' },
    { text: 'Coffee Shop Renovation', src: '/assets/2.jpg', alt: 'alt' },
    {
